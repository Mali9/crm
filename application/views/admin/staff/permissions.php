                        ...
                        <?php foreach ($permission['capabilities'] as $capability => $name) {
                            ...
                            <div class="tw-ml-2">
                                <div class="checkbox last:tw-mb-0">
                                    <input <?php if ($capability == 'view') { ?> data-can-view <?php } ?> <?php if ($capability == 'view_own') { ?> data-can-view-own <?php } ?> <?php if (is_array($name) && isset($name['not_applicable']) && $name['not_applicable']) { ?> data-not-applicable="true" <?php } ?> type="checkbox" <?php echo e($checked); ?> class="capability" id="<?php echo $feature . '_' . $capability; ?>" name="permissions[<?php echo e($feature); ?>][]" value="<?php echo e($capability); ?>" <?php echo e($disabled); ?>>
